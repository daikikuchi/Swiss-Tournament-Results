...
# these test cases as appropriate to account for your module's
# added functionality.
...
def testReportMatches():
    ...
    for (i, n, w, m) in standings:
        ...
        if w != 0:
            raise ValueError(
                "After deleting matches, players should "
...
def testPairings():
    """
    Test that pairings are generated properly both before
    and after match reporting.
    """
    deleteMatches()
    deletePlayers()
